...
def check_for_updating(data, frequency=True):
    ...
    if frequency and (time_delta.days >= 1 or time_delta.seconds > 60 * 60):
        return True

    # if not frequency and time_delta.days > 30:
    #     return True

    if not frequency and time_delta.seconds > 60 * 60 * 24:
        return True
    return False
...
def get_managers_data():
    print("Call get mng data function")
